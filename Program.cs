    ...
    class Program
    {
        ...
        private static IEnumerable<ulong> Primes3()
        {
            ...
            */
            ...
            /* если кандидатов гораздо больше, чем процессоров в системе
                то можно:
                создаём таски в соответствии с кол-вом процессоров
                в каждой таске делаем List<()> для индексов
                каждый таск анализирует пачку кандидатов
                таск возвращает List<()>
                когда все таски завершены, в одном отдельном потоке обновляем биты в соответствии с результатами тасков
